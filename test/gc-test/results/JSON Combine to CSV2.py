...
for index in range(1,200):
    var = f'C:/Users/amzv3/Documents/Github/REopt.jl/test/gc-test/results/run_edgecases_{index}.json'
...
df_selected.to_csv('test/gc-test/results/ReOPT_edge_cases_output.csv', index=False)
